...
def main():
    ...
    for subj in test_subjs:
        ...
        # output orig path
        path1 = '/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/RS/update/' + subj + '_orig.nii.gz'
        # output denoised path
        path2 = '/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/RS/update/' + subj + '_denoised.nii.gz'
