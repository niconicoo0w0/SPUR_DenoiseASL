...
SUBIDS=['GE_05', 'GE_07', 'GE_09', 'GE_11', 'GE_13',
        'GE_15', 'GE_17', 'GE_19', 'GE_21', 'GE_23',
        'GE_27', 'GE_29', 'GE_30']
#  test on remaining subjects (~15)
TEST_SUBJECT=['GE_04', 'GE_06', 'GE_08', 'GE_10', 'GE_12',
              'GE_14', 'GE_16','GE_18', 'GE_20', 'GE_22',
              'GE_26', 'GE_31', 'GE_32', 'GE_33', 'GE_36']
...
def get_nifti_data(subj, chunk_size=chunk_size, overlap=0, target=0):
    ...
    if target == 1:
        nifti_file = nib.load('/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/BH/' + subj + '_GE_MBME_BH_ASL_s4_mean.nii.gz')
    else:
        nifti_file = nib.load('/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/BH/' + subj + '_GE_MBME_BH_ASL_s4.nii.gz')
...
def main():
    ...
    for subj in test_subjs:
        orig_path = '/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/BH/' + subj + '_GE_MBME_BH_ASL_s4.nii.gz'
        ...
        # output orig path
        path1 = '/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/BH/update/' + subj + '_orig.nii.gz'
        # output denoised path
        path2 = '/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/BH/update/' + subj + '_denoised.nii.gz'
