...
def get_nifti_data(subj, chunk_size=chunk_size, overlap=0, target=0):
    ...
    if target == 1:
        nifti_file = nib.load('/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/RS/' + subj + '_GE_MBME_RS_ASL_s4_rs35_mean.nii.gz')
    else:
        nifti_file = nib.load('/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/RS/' + subj + '_GE_MBME_RS_ASL_s4_rs35.nii.gz')
...
def main():
    ...
    for subj in test_subjs:     
        ...
        orig_path = '/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/RS/' + subj + '_GE_MBME_RS_ASL_s4_rs35.nii.gz'
        save_as_nifti(denoised_image, '/data/GE_MCI/Scripts/DenoiseASL/NicoleTest/GE_MBME_ASL_RS/ASL/RS/Result/' + subj + '_denoised.nii.gz', orig_path)
