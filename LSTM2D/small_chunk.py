...
# Smaller chunk
def get_nifti_data(path, chunk_size=chunck_size):
    ...
    if data.ndim == 4:
        ...
        # (91, 1, 109, 91) => (91, 168, 109, 91)
        data = np.repeat(data, num_timepoint, axis=1)
        # (91, 168, 109, 91) => (91, 168, 91, 109)
...
def main():
    ...
    for i, path in enumerate(input_paths):
        ...
        denoised_image = np.concatenate(denoised_image_chunks, axis=2)
